    ...
    '5f7t': function (e, t, o) {
      ...
      const S = [
        ...
        },
        {
          ...
          items: [
            ...
            Object(C.isFeatureEnabled)('remove-line-tool-ghost-feed')
              ? null
            ...
            n.a.createElement(
              ...
              o &&
                n.a.createElement('div', {
                  className: c()(E.fadeTop, { [E.isVisible]: h && l > r }),
                }),
              o &&
                n.a.createElement('div', {
                  className: c()(E.fadeBot, { [E.isVisible]: d && l > r }),
                }),
              i &&
                n.a.createElement(
                  'div',
                  {
                    className: c()(E.scrollTop, { [E.isVisible]: h && l > r }),
              ...
              i &&
                n.a.createElement(
                  'div',
                  {
                    className: c()(E.scrollBot, { [E.isVisible]: d && l > r }),
        ...
        constructor(e) {
          super(e),
            ...
            (this._handlePressStart = () => {
              if (Modernizr.mobiletouch && !this.props.checkable)
                this._longPressDelay || this.props.onClickButton();
              else {
          ...
          super(e),
            ...
            (this._handleSelect = (e) => {
              Object(V.saveDefaults)(
                'linetoolicon',
                Object.assign(
                  Object.assign({}, Object(V.defaults)('linetoolicon')),
                  { icon: e }
                )
              ),
        ...
        constructor(e) {
          super(e),
            ...
            (this._handleGrayedClick = (e) => {
              Object(b.emit)('onGrayedObjectClicked', {
                type: 'drawing',
                name: _.a[e].localizedName,
              });
            }),
            (this._handleClickFavorite = (e) => {
              this.state.favState && this.state.favState[e]
                ? X.a.removeFavorite(e)
                : X.a.addFavorite(e);
            }),
            (this._onAddFavorite = (e) => {
              this.setState({
                favState: Object.assign(
                  Object.assign({}, this.state.favState),
                  { [e]: !0 }
                ),
              });
            }),
            ...
            i.createElement(
              ...
              o.map((o, n) => {
                ...
                return i.createElement($.b, {
                  ...
                  shortcut:
                    !s && o.hotkeyHash
                      ? Object(T.humanReadableHash)(o.hotkeyHash)
                      : void 0,
                  icon: d.icon,
                  isActive: r && a === n,
                  appearAsDisabled: u,
      ...
      function ce(e) {
        const {
          ...
          [a, r] = Object(i.useState)(() =>
            d.getValue('ChartToolsHideMode', 'drawings')
          ),
          ...
          I,
          {
            buttonIcon: (function () {
              switch (a) {
                case 'drawings':
                  return c
                    ? re.a.hideAllDrawingToolsActive
                    : re.a.hideAllDrawingTools;
                case 'indicators':
                  return u
                    ? re.a.hideAllIndicatorsActive
                    : re.a.hideAllIndicators;
                default:
                  return c && u
                    ? re.a.hideAllDrawingsActive
                    : re.a.hideAllDrawings;
              }
            })(),
            buttonTitle: (function () {
              switch (a) {
                case 'drawings':
                  return p
                    ? Object(l.t)('Show all drawings')
                    : Object(l.t)('Hide all drawings');
                case 'indicators':
                  return p
                    ? Object(l.t)('Show all indicators')
                    : Object(l.t)('Hide all indicators');
                default:
                  return p
          ...
          n.a.createElement($.b, {
            ...
            onClick: function () {
              ...
              t.setValue(e),
                o.setValue(e),
                w('all'),
                he('hide drawings and indicators', e);
            },
      ...
      class pe extends i.PureComponent {
        ...
        componentDidMount() {
          const e = (this._promise = Object(a.ensureNotNull)(
            Object(ue.getFavoriteDrawingToolbarPromise)()
          ));
          e.then((t) => {
            this._promise === e &&
              ((this._instance = t),
        ...
        constructor() {
          super(...arguments),
            (this._toggleVisibility = () => {
              y.isDrawingToolbarVisible.setValue(
                !y.isDrawingToolbarVisible.value()
              );
            });
        }
        render() {
      ...
      class Ge extends i.PureComponent {
        ...
        render() {
          ...
          const m = () =>
            !!this._features.tools && !!h.enabled('show_object_tree');
          return i.createElement(
            Be.a,
        ...
        constructor(e, t) {
          (this._component = null),
            ...
            s.render(
              i.createElement(
                Ge,
                Object.assign({}, t, { ref: this._handleRef })
              ),
              this._container
            );
        }
        ...
        return (
          Object(i.useEffect)(() => {
            ...
            return (
              ...
              h.CheckMobile.iOS() &&
                Object(l.disableBodyScroll)(Object(s.ensureNotNull)(T.current)),
              w(v.addDrawer()),
              () => {
                C.unsubscribe(v, o);
                ...
                h.CheckMobile.iOS() &&
                  Object(l.enableBodyScroll)(
                    Object(s.ensureNotNull)(T.current)
                  ),
          ...
          n.a.createElement(
            ...
            n.a.createElement(
              ...
              _ === v.currentDrawer &&
                n.a.createElement('div', { className: m.backdrop, onClick: o }),
              n.a.createElement(
                'div',
                {
